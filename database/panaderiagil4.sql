...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-09-2016 a las 16:52:47
...
-- Base de datos: `panaderiagil3`
--
CREATE DATABASE IF NOT EXISTS `panaderiagil4` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `panaderiagil4`;
...
-- VISTA INVENTARIO
--
CREATE VIEW mostrar AS SELECT i.idI,i.idP,p.nombre,i.existencia,i.fecha FROM 
inventario i
inner join panes p
on i.idP=p.idP;
